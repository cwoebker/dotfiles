...
Plug 'Lokaltog/vim-powerline', { 'branch': 'develop' } " powerline statusline
...
Plug 'python-mode/python-mode'				" python ide stuff
Plug 'jmcantrell/vim-virtualenv'			" show virtualenv in python
Plug 'myusuf3/numbers.vim'					" easily manage where line numbers show up
Plug 'vim-scripts/Gundo'					" visualize vim undo tree
Plug 'wincent/command-t'					" quick vim file navigation
Plug 'mileszs/ack.vim'						" better grep search in vim (ack)
